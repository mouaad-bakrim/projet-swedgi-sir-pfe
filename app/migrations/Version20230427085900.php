 ...
 */
final class Version20230427085900 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE periodicite (id INT AUTO_INCREMENT NOT NULL, designation VARCHAR(255) NOT NULL, duree DOUBLE PRECISION DEFAULT NULL, direct TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
