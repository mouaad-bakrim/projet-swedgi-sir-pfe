!function (t) {
    ...
    return function t(e, n, i) {
        ...
        1: [function (t, e, n) {
            ...
            function a(t) {
                if (t) {
                    var e = /^hsla?\(\s*([+-]?\d+)(?:deg)?\s*,\s*([+-]?[\d\.]+)%\s*,\s*([+-]?[\d\.]+)%\s*(?:,\s*([+-]?[\d\.]+)\s*)?\)/,
                        n = t.match(e);
                    if (n) {
                        var i = parseFloat(n[4]), a = b(parseInt(n[1]), 0, 360), r = b(parseFloat(n[2]), 0, 100),
                            o = b(parseFloat(n[3]), 0, 100), l = b(isNaN(i) ? 1 : i, 0, 1);
                        return [a, r, o, l]
                    }
                }
            }
            ...
            function i(t) {
                var e, n, i, a = t[0] / 255, r = t[1] / 255, o = t[2] / 255, l = Math.min(a, r, o),
                    s = Math.max(a, r, o), u = s - l;
            ...
            function o(t) {
                var e = t[0], n = t[1], a = t[2], r = i(t)[0], o = 1 / 255 * Math.min(e, Math.min(n, a)),
            ...
            function u(t) {
                ...
                var a = .4124 * e + .3576 * n + .1805 * i, r = .2126 * e + .7152 * n + .0722 * i,
            ...
            function x(t) {
                var e = t[0] / 60, n = t[1] / 100, i = t[2] / 100, a = Math.floor(e) % 6, r = e - Math.floor(e),
                    o = 255 * i * (1 - n), l = 255 * i * (1 - n * r), s = 255 * i * (1 - n * (1 - r)), i = 255 * i;
                switch (a) {
                    case 0:
                        return [i, s, o];
                    case 1:
            ...
            for (var r in i) {
                ...
                var o = /(\w+)2(\w+)/.exec(r), l = o[1], s = o[2];
            ...
            e.exports = function (t) {
                ...
                t.defaults.bar = {
                    ...
                    dataElementType: t.elements.Rectangle, initialize: function () {
                        ...
                        var a = this, r = a.chart, o = a.getMeta(), l = a.getDataset(), s = t.custom || {},
                        ...
                        var i = this, a = t._model, r = i.getValueScale(), o = r.getBasePixel(), l = r.isHorizontal(),
                        ...
                        var e, n, i = this, a = i.chart, r = i.getIndexScale(), o = r.options.stacked,
                        ...
                        var t = this, n = t.getIndexScale(), i = n.options, a = t.getStackCount(),
                            r = n.isHorizontal() ? n.width : n.height, o = r / n.ticks.length,
                            l = o * i.categoryPercentage, s = l / a, u = s * i.barPercentage;
                        ...
                        var n, i, a, r, o, l, s = this, u = s.chart, d = s.getMeta(), c = s.getValueScale(),
                            h = u.data.datasets, f = Number(h[t].data[e]), g = c.options.stacked, p = d.stack, m = 0;
                        if (g || void 0 === g && void 0 !== p) for (n = 0; t > n; ++n) i = u.getDatasetMeta(n), i.bar && i.stack === p && i.controller.getValueScaleId() === c.id && u.isDatasetVisible(n) && (a = Number(h[n].data[e]), (0 > f && 0 > a || f >= 0 && a > 0) && (m += a));
                        ...
                        var i = this, a = n.scale, r = i.chart.isCombo, o = i.getStackIndex(t),
                            l = a.getPixelForValue(null, e, t, r), s = n.barSize;
                        ...
                        var n = this.chart.data.datasets[t._datasetIndex], i = t._index, a = t.custom || {},
                            r = t._model, o = this.chart.options.elements.rectangle;
            ...
            e.exports = function (t) {
                ...
                t.defaults.bubble = {
                    ...
                    dataElementType: t.elements.Point, update: function (t) {
                        ...
                        var r = this, o = r.getMeta(), l = r.getScaleForId(o.xAxisID), s = r.getScaleForId(o.yAxisID),
                            u = n.custom || {}, d = r.getDataset(), c = d.data[i], h = r.chart.options.elements.point,
                            f = r.index;
                        e.extend(n, {
                            _xScale: l,
                            _yScale: s,
                        ...
                        var a = i.chart.data.datasets[n._datasetIndex], r = n._index, o = n.custom || {}, l = n._model;
                        ...
                        var i = n.chart.data.datasets[e._datasetIndex].data[e._index], a = e.custom || {}, r = e._model;
            ...
            e.exports = function (t) {
                ...
                n.doughnut = {
                        ...
                        labels: {
                            generateLabels: function (t) {
                                ...
                                return n.labels.length && n.datasets.length ? n.labels.map(function (i, a) {
                                    var r = t.getDatasetMeta(0), o = n.datasets[0], l = r.data[a],
                    ...
                    dataElementType: t.elements.Arc, linkScales: e.noop, getRingIndex: function (t) {
                        ...
                        var n = this, i = n.chart, a = i.chartArea, r = i.options, o = r.elements.arc,
                            l = a.right - a.left - o.borderWidth, s = a.bottom - a.top - o.borderWidth,
                            u = Math.min(l, s), d = {x: 0, y: 0}, c = n.getMeta(), h = r.cutoutPercentage,
                            f = r.circumference;
                        if (f < 2 * Math.PI) {
                        ...
                        var a = this, r = a.chart, o = r.chartArea, l = r.options, s = l.animation,
                            u = (o.left + o.right) / 2, d = (o.top + o.bottom) / 2, c = l.rotation, h = l.rotation,
                            f = a.getDataset(),
            ...
            e.exports = function (t) {
                ...
                t.defaults.line = {
                    ...
                    datasetElementType: t.elements.Line, dataElementType: t.elements.Point, update: function (t) {
                        var i, a, r, o = this, l = o.getMeta(), s = l.dataset, u = l.data || [], d = o.chart.options,
                            c = d.elements.line, h = o.getScaleForId(l.yAxisID), f = o.getDataset(), g = e(f, d);
                        ...
                        var a, r, o = this, l = o.getMeta(), s = t.custom || {}, u = o.getDataset(), d = o.index,
                            c = u.data[e], h = o.getScaleForId(l.yAxisID), f = o.getScaleForId(l.xAxisID),
                            g = o.chart.options.elements.point, p = o.chart.data.labels || [],
                        ...
                        var i, a, r, o = this, l = o.chart, s = o.getMeta(), u = o.getScaleForId(s.yAxisID), d = 0,
                            c = 0;
                        if (u.options.stacked) {
                            for (i = 0; n > i; i++) if (a = l.data.datasets[i], r = l.getDatasetMeta(i), "line" === r.type && r.yAxisID === u.id && l.isDatasetVisible(i)) {
                        ...
                        })), "monotone" === s.dataset._model.cubicInterpolationMode) n.splineCurveMonotone(d); else for (e = 0, i = d.length; i > e; ++e) a = d[e], r = a._model, o = n.splineCurve(n.previousItem(d, e)._model, r, n.nextItem(d, e)._model, s.dataset._model.tension), r.controlPointPreviousX = o.previous.x, r.controlPointPreviousY = o.previous.y, r.controlPointNextX = o.next.x, r.controlPointNextY = o.next.y;
                        if (l.chart.options.elements.line.capBezierPoints) for (e = 0, i = d.length; i > e; ++e) r = d[e]._model, r.controlPointPreviousX = t(r.controlPointPreviousX, u.left, u.right), r.controlPointPreviousY = t(r.controlPointPreviousY, u.top, u.bottom), r.controlPointNextX = t(r.controlPointNextX, u.left, u.right), r.controlPointNextY = t(r.controlPointNextY, u.top, u.bottom)
                    }, draw: function () {
                        var n = this, i = n.chart, a = n.getMeta(), r = a.data || [], o = i.chartArea, l = r.length,
                            s = 0;
                        ...
                        var e = this, i = e.chart.data.datasets[t._datasetIndex], a = t._index, r = t.custom || {},
                            o = t._model;
            ...
            e.exports = function (t) {
                ...
                t.defaults.polarArea = {
                    ...
                    legend: {
                        labels: {
                            generateLabels: function (t) {
                                var n = t.data;
                                return n.labels.length && n.datasets.length ? n.labels.map(function (i, a) {
                                    var r = t.getDatasetMeta(0), o = n.datasets[0], l = r.data[a], s = l.custom || {},
                    ...
                    dataElementType: t.elements.Arc, linkScales: e.noop, update: function (t) {
                        var n = this, i = n.chart, a = i.chartArea, r = n.getMeta(), o = i.options, l = o.elements.arc,
                        ...
                        var b = l.startAngle, x = t.hidden ? 0 : u.getDistanceFromCenterForValue(o.data[n]),
            ...
            e.exports = function (t) {
                ...
                t.defaults.radar = {
                    ...
                    linkScales: e.noop,
                    update: function (t) {
                        var n = this, i = n.getMeta(), a = i.dataset, r = i.data, o = a.custom || {},
                    ...
                    updateElement: function (t, n, i) {
                        var a = this, r = t.custom || {}, o = a.getDataset(), l = a.chart.scale,
                            s = a.chart.options.elements.point, u = l.getPointPositionForValue(n, o.data[n]);
                    ...
                    removeHoverStyle: function (t) {
                        var n = this.chart.data.datasets[t._datasetIndex], i = t.custom || {}, a = t._index,
                            r = t._model, o = this.chart.options.elements.point;
            ...
            e.exports = function (t) {
                ...
                t.defaults.global.animation = {
                    ...
                    addAnimation: function (t, e, n, i) {
                        ...
                        for (e.chart = t, i || (t.animating = !0), a = 0, r = o.length; r > a; ++a) if (o[a].chart === t) return void (o[a] = e);
                    ...
                    if (!(isNaN(i) || 0 >= i)) {
                        switch (n) {
                            ...
                            case"rect":
                                ...
                                break;
                            case"rectRounded":
                                var h = i / Math.SQRT2, f = a - h, g = r - h, p = Math.SQRT2 * i;
            ...
            e.exports = function (t) {
                ...
                var a = t.helpers, r = t.plugins, o = t.platform;
                t.types = {}, t.instances = {}, t.controllers = {}, a.extend(t.prototype, {
                    construct: function (n, i) {
                        var r = this;
                        i = e(i);
                        var l = o.acquireContext(n, i), s = l && l.canvas, u = s && s.height, d = s && s.width;
                        ...
                        var e = this, n = e.options, i = e.canvas, o = n.maintainAspectRatio && e.aspectRatio || null,
                            l = Math.floor(a.getMaximumWidth(i)), s = Math.floor(o ? l / o : a.getMaximumHeight(i));
                        ...
                        var e = this, n = e.options, r = e.scales = {}, o = [];
                        n.scales && (o = o.concat((n.scales.xAxes || []).map(function (t) {
                            ...
                            var o = n.options, l = a.getValueOrDefault(o.type, n.dtype),
                        ...
                        }, e), n.length > 1) for (var r = 1; r < n.length; r++) if (n[r] !== n[r - 1]) {
                            e.isCombo = !0;
                            break
                        }
                        return i
                        ...
                        if (r.notify(i, "beforeRender") !== !1) {
                            var o = i.options.animation, l = function (t) {
                            ...
                            if (o && ("undefined" != typeof e && 0 !== e || "undefined" == typeof e && 0 !== o.duration)) {
                                var s = new t.Animation({
                                    ...
                                    easing: o.easing,
                                    render: function (t, e) {
                                        var n = a.easingEffects[e.easing], i = e.currentStep, r = i / e.numSteps;
                                        t.draw(n(r), r, i)
                                    },
                ...
                t.DatasetController = function (t, e) {
                    ...
                    datasetElementType: null, dataElementType: null, initialize: function (t, e) {
                        ...
                        var n = this.chart.data.datasets[t._datasetIndex], a = t._index, r = t.custom || {},
                            o = i.getValueAtIndexOrDefault, l = t._model;
                        ...
                        var e = this.chart.data.datasets[t._datasetIndex], n = t._index, a = t.custom || {},
                            r = i.getValueAtIndexOrDefault, o = i.getHoverColor, l = t._model;
            ...
            e.exports = function (t) {
                function e(t, e, n, a) {
                    ...
                    for (r = 0, o = g.length; o > r; ++r) if (l = g[r], d = n[l], e.hasOwnProperty(l) || (e[l] = d), s = e[l], s !== d && "_" !== l[0]) {
                ...
                t.elements = {}, t.Element = function (t) {
                    ...
                    initialize: function () {
                        ...
                        var n = this, i = n._model, a = n._start, r = n._view;
            ...
            e.exports = function (t) {
                ...
                function a(t, i, a) {
                    var r = document.defaultView, o = t.parentNode, l = r.getComputedStyle(t)[i],
                        s = r.getComputedStyle(o)[i], u = n(l), d = n(s), c = Number.POSITIVE_INFINITY;
                ...
                r.each = function (t, e, n, i) {
                    var a, o;
                    if (r.isArray(t)) if (o = t.length, i) for (a = o - 1; a >= 0; a--) e.call(n, t[a], a); else for (a = 0; o > a; a++) e.call(n, t[a], a); else if ("object" == typeof t) {
                        var l = Object.keys(t);
                    ...
                    return r.each(Array.prototype.slice.call(arguments, 1), function (e) {
                        r.each(e, function (e, i) {
                            var a = n.hasOwnProperty(i), o = a ? n[i] : {};
                    ...
                    var a = t.skip ? e : t, r = e, o = n.skip ? e : n,
                        ...
                        s = Math.sqrt(Math.pow(o.x - r.x, 2) + Math.pow(o.y - r.y, 2)), u = l / (l + s),
                        d = s / (l + s);
                    ...
                    for (e = 0; l > e; ++e) if (i = o[e], !i.model.skip) {
                ...
                r.requestAnimFrame = function () {
                    ...
                    var n, i, a = t.originalEvent || t, o = t.currentTarget || t.srcElement,
                        l = o.getBoundingClientRect(), s = a.touches;
                    ...
                    var e = t.parentNode, n = parseInt(r.getStyle(e, "padding-left"), 10),
                    ...
                    var e = t.parentNode, n = parseInt(r.getStyle(e, "padding-top"), 10),
                    ...
                    for (n = 0, i = t.length; i > n; ++n) if (a = t[n], o = e[n], a instanceof Array && o instanceof Array) {
            ...
            e.exports = function (t) {
                ...
                function n(t, e) {
                    ...
                    for (i = 0, r = l.length; r > i; ++i) if (t.isDatasetVisible(i)) for (n = t.getDatasetMeta(i), a = 0, o = n.data.length; o > a; ++a) {
                        var s = n.data[a];
                        s._view.skip || e(s)
                    }
                }
                ...
                function a(t, e, i, a) {
                    ...
                    return a || (a = o.distanceBetweenPoints), n(t, function (t) {
                        if (!i || t.inRange(e.x, e.y)) {
                            var n = t.getCenterPoint(), o = a(e, n);
                ...
                function r(t, n, r) {
                    var o = e(n, t), l = function (t, e) {
                        return Math.abs(t.x - e.x)
                    }, s = r.intersect ? i(t, o) : a(t, o, !1, l), u = [];
                ...
                t.Interaction = {
                    modes: {
                        single: function (t, i) {
                        ...
                        }, label: r, index: r, dataset: function (t, n, r) {
                            var o = e(n, t), l = r.intersect ? i(t, o) : a(t, o, !1);
                            ...
                            var r = e(n, t), o = a(t, r, i.intersect);
                ...
                t.layoutService = {
                    defaults: {}, addBox: function (t, e) {
                        ...
                        if (t) {
                            ...
                            var k = a - h - f, w = r - g - p, M = k / 2, S = w / 2, C = (a - M) / (m.length + v.length),
                                D = (r - S) / (b.length + x.length), I = k, A = w, P = [];
            ...
            e.exports = function (t) {
                ...
                t.defaults.global.plugins = {}, t.plugins = {
                    _plugins: [], _cacheId: 0, register: function (t) {
                        ...
                        for (i = 0; u > i; ++i) if (a = s[i], r = a.plugin, l = r[e], "function" == typeof l && (o = [t].concat(n || []), o.push(a.options), l.apply(r, o) === !1)) return !1;
                        return !0
                    }, descriptors: function (n) {
                        var i = n._plugins || (n._plugins = {});
                        if (i.id === this._cacheId) return i.descriptors;
                        var a = [], r = [], o = n && n.config || {}, l = t.defaults.global.plugins,
            ...
            e.exports = function (t) {
                ...
                function n(e) {
                    var n = i.getValueOrDefault, a = t.defaults.global, r = n(e.fontSize, a.defaultFontSize),
                        o = n(e.fontStyle, a.defaultFontStyle), l = n(e.fontFamily, a.defaultFontFamily);
                ...
                t.defaults.scale = {
                    ...
                    calculateTickRotation: function () {
                        var t = this, e = t.ctx, a = t.options.ticks, r = n(a);
                        e.font = r.font;
                    ...
                    fit: function () {
                        var t = this, a = t.minSize = {width: 0, height: 0}, r = t.options, o = r.ticks,
                            l = r.scaleLabel, s = r.gridLines, u = r.display, d = t.isHorizontal(), c = n(o),
                            h = 1.5 * n(l).size, f = r.gridLines.tickMarkLength;
                    ...
                    draw: function (e) {
                        ...
                        if (r.display) {
                            var o, l, s = a.ctx, u = t.defaults.global, d = r.ticks, c = r.gridLines, h = r.scaleLabel,
                            ...
                            var S = [];
                            if (p) {
                                if (o = !1, (M + d.autoSkipPadding) * a.ticks.length > a.width - (a.paddingLeft + a.paddingRight) && (o = 1 + Math.floor((M + d.autoSkipPadding) * a.ticks.length / (a.width - (a.paddingLeft + a.paddingRight)))), l && a.ticks.length > l) for (; !o || a.ticks.length / (o || 1) > l;) o || (o = 1), o += 1;
                                g || (o = !1)
                            }
                ...
                t.Ticks = {
                    generators: {
                        linear: function (t, n) {
                            ...
                            var o = Math.floor(n.min / i) * i, l = Math.ceil(n.max / i) * i;
                            ...
                            var i, a, r = [], o = e.getValueOrDefault,
                                l = o(t.min, Math.pow(10, Math.floor(e.log10(n.min)))), s = Math.floor(e.log10(n.max)),
            ...
            e.exports = function (t) {
                ...
                function l(t, e, n) {
                    var i = t.x, a = t.y, r = t.caretSize, o = t.caretPadding, l = t.cornerRadius, s = n.xAlign,
                        u = n.yAlign, d = r + o, c = l + o;
                ...
                t.defaults.global.tooltips = {
                    ...
                    initialize: function () {
                        ...
                        var t = this, e = t._options, i = e.callbacks, a = i.beforeTitle.apply(t, arguments),
                            r = i.title.apply(t, arguments), o = i.afterTitle.apply(t, arguments), l = [];
                        ...
                        var i, a, r, o, l, s, u = n.caretSize, d = n.cornerRadius, c = n.xAlign, h = n.yAlign, f = t.x,
                        ...
                        if (r.length) {
                            ...
                            var o = n.titleFontSize, l = n.titleSpacing;
                        ...
                        var r = n.bodyFontSize, o = n.bodySpacing, l = n.body;
                        ...
                        var o = n.xAlign, l = n.yAlign, s = t.x, u = t.y, d = a.width, c = a.height, h = n.cornerRadius;
                ...
                n.elements.arc = {
                    ...
                    inLabelRange: function (t) {
                        ...
                        if (i) {
                            ...
                            for (; r > s;) r -= 2 * Math.PI;
                            for (; l > r;) r += 2 * Math.PI;
                            var u = r >= l && s >= r, d = o >= i.innerRadius && o <= i.outerRadius;
                            return u && d
                        }
                        return !1
            ...
            e.exports = function (t) {
                ...
                t.defaults.global.elements.line = {
                    ...
                    draw: function () {
                        var t, i, a, r, o = this, l = o._view, s = o._chart.ctx, u = l.spanGaps,
                            d = o._children.slice(), c = n.elements.line, h = -1;
            ...
            e.exports = function (t) {
                ...
                var i = t.helpers, a = t.defaults.global, r = a.defaultColor;
                a.elements.point = {
                    radius: 3,
                    pointStyle: "circle",
                    backgroundColor: r,
                    ...
                    inRange: function (t, e) {
                        ...
                        var n = this._view, o = this._model, l = this._chart.ctx, s = n.pointStyle, u = n.radius,
                ...
                i.elements.rectangle = {
                    ...
                    draw: function () {
                        ...
                        if (u.horizontal ? (e = u.base, n = u.x, i = u.y - u.height / 2, a = u.y + u.height / 2, r = n > e ? 1 : -1, o = 1, l = u.borderSkipped || "left") : (e = u.x - u.width / 2, n = u.x + u.width / 2, i = u.y, a = u.base, r = 1, o = a > i ? 1 : -1, l = u.borderSkipped || "bottom"), d) {
                            ...
                            d = d > c ? c : d;
                            var h = d / 2, f = e + ("left" !== l ? h * r : 0), g = n + ("right" !== l ? -h * r : 0),
                                p = i + ("top" !== l ? h * o : 0), m = a + ("bottom" !== l ? -h * o : 0);
            ...
            e.exports = function (t) {
                ...
                function n(t, n) {
                    var i = t.style, a = t.getAttribute("height"), r = t.getAttribute("width");
                    if (t._chartjs = {
                        initial: {
                            height: a,
                            width: r,
                ...
                function o(t, e, n) {
                    var a = t._chartjs = {ticking: !1}, o = function () {
                ...
                return {
                    acquireContext: function (t, e) {
                        ...
                        var r = n._chartjs || (n._chartjs = {}), l = r.proxies || (r.proxies = {}),
            ...
            e.exports = function (t) {
                ...
                return {
                    id: "filler", afterDatasetsUpdate: function (r, o) {
                        ...
                        var n = e.meta.$filler;
                        if (n) {
                            var i = n.el, a = i._view, r = i._children || [], o = n.mapper,
            ...
            e.exports = function (t) {
                ...
                var i = t.helpers, a = t.layoutService, r = i.noop;
                return t.defaults.global.legend = {
                    ...
                    initialize: function (t) {
                    ...
                    }, beforeUpdate: r, update: function (t, e, n) {
                        var i = this;
                        ...
                        var n = this, a = n.options, r = a.labels, o = a.display, l = n.ctx, s = t.defaults.global,
                            u = i.getValueOrDefault, d = u(r.fontSize, s.defaultFontSize),
                            c = u(r.fontStyle, s.defaultFontStyle), h = u(r.fontFamily, s.defaultFontFamily),
                        ...
                        if (m ? (p.width = n.maxWidth, p.height = o ? 10 : 0) : (p.width = o ? 10 : 0, p.height = n.maxHeight), o) if (l.font = f, m) {
                            var v = n.lineWidths = [0], b = n.legendItems.length ? d + r.padding : 0;
                            l.textAlign = "left", l.textBaseline = "top", i.each(n.legendItems, function (t, i) {
                                var a = e(r, d), o = a + d / 2 + l.measureText(t.text).width;
                            ...
                            var x = r.padding, y = n.columnWidths = [], k = r.padding, w = 0, M = 0, S = d + x;
                            i.each(n.legendItems, function (t, n) {
                                var i = e(r, d), a = i + d / 2 + l.measureText(t.text).width;
                        ...
                        var n = this, a = n.options, r = a.labels, o = t.defaults.global, l = o.elements.line,
                            s = n.width, u = n.lineWidths;
                        if (a.display) {
                            var d, c = n.ctx, h = i.getValueOrDefault, f = h(r.fontColor, o.defaultFontColor),
                                g = h(r.fontSize, o.defaultFontSize), p = h(r.fontStyle, o.defaultFontStyle),
                                m = h(r.fontFamily, o.defaultFontFamily), v = i.fontString(g, p, m);
                            c.textAlign = "left", c.textBaseline = "top", c.lineWidth = .5, c.strokeStyle = f, c.fillStyle = f, c.font = v;
                            var b = e(r, g), x = n.legendHitBoxes, y = function (e, n, i) {
                                if (!(isNaN(b) || 0 >= b)) {
                            ...
                            i.each(n.legendItems, function (t, e) {
                                var i = c.measureText(t.text).width, a = b + g / 2 + i, o = d.x, l = d.y;
                    ...
                    id: "legend", beforeInit: function (t) {
                        ...
                        var r = e.options.legend, o = e.legend;
            ...
            e.exports = function (t) {
                ...
                return t.defaults.global.title = {
                    ...
                    beforeFit: a,
                    fit: function () {
                        var e = this, i = n.getValueOrDefault, a = e.options, r = t.defaults.global, o = a.display,
                            l = i(a.fontSize, r.defaultFontSize), s = e.minSize;
                    ...
                    draw: function () {
                        var e = this, i = e.ctx, a = n.getValueOrDefault, r = e.options, o = t.defaults.global;
                        if (r.display) {
                            var l, s, u, d = a(r.fontSize, o.defaultFontSize), c = a(r.fontStyle, o.defaultFontStyle),
                                h = a(r.fontFamily, o.defaultFontFamily), f = n.fontString(d, c, h), g = 0, p = e.top,
                    ...
                    id: "title", beforeInit: function (t) {
                        ...
                        var r = a.options.title, o = a.titleBlock;
                ...
                var e = t.helpers, n = {position: "bottom"}, i = t.Scale.extend({
                    getLabels: function () {
                        ...
                        var e, n = this,
                            ...
                            a = n.isHorizontal(), r = (a ? n.width : n.height) / i;
                ...
                var e = t.helpers, n = {position: "left", ticks: {callback: t.Ticks.formatters.linear}},
                    i = t.LinearScaleBase.extend({
                        determineDataLimits: function () {
                            ...
                            var n = this, i = n.options, a = n.chart, r = a.data, o = r.datasets, l = n.isHorizontal(),
                                s = 0, u = 1;
                            ...
                            if (void 0 === d && e.each(o, function (e, n) {
                                ...
                                e.each(o, function (r, o) {
                                    ...
                                    var i = t.positiveValues.concat(t.negativeValues), a = e.min(i), r = e.max(i);
            ...
            e.exports = function (t) {
                ...
                t.LinearScaleBase = t.Scale.extend({
                    handleTickRangeOptions: function () {
                        ...
                        if (i.beginAtZero) {
                            var a = e.sign(t.min), r = e.sign(t.max);
                        ...
                        var n = this, i = n.options, a = i.ticks, r = n.getTickLimit();
                        r = Math.max(2, r);
                        var o = {
                            maxTicks: r,
                            min: a.min,
                ...
                var e = t.helpers, n = {position: "left", ticks: {callback: t.Ticks.formatters.logarithmic}},
                    i = t.Scale.extend({
                        determineDataLimits: function () {
                            ...
                            var n = this, i = n.options, a = i.ticks, r = n.chart, o = r.data, l = o.datasets,
                            ...
                            var n = this, i = n.options, a = i.ticks, r = {min: a.min, max: a.max},
            ...
            e.exports = function (t) {
                ...
                function n(t) {
                    var e = t.options.pointLabels, n = f.getValueOrDefault(e.fontSize, g.defaultFontSize),
                        ...
                        a = f.getValueOrDefault(e.fontFamily, g.defaultFontFamily), r = f.fontString(n, i, a);
                ...
                function a(t, e, n, i, a) {
                    return t === i || t === a ? {start: e - n / 2, end: e + n / 2} : i > t || t > a ? {
                        start: e - n - 5,
                        end: e
                    } : {start: e, end: e + n + 5}
                }
                ...
                function r(t) {
                    var r, o, l, s = n(t), u = Math.min(t.height / 2, t.width / 2),
                    ...
                    for (r = 0; h > r; r++) {
                        ...
                        var g = t.getIndexAngle(r), p = f.toDegrees(g) % 360, m = a(p, l.x, o.w, 0, 180),
                ...
                function s(t, e, n, i) {
                    if (f.isArray(e)) for (var a = n.y, r = 1.5 * i, o = 0; o < e.length; ++o) t.fillText(e[o], n.x, a), a += r; else t.fillText(e, n.x, n.y)
                }
                ...
                function d(t) {
                    var i = t.ctx, a = f.getValueOrDefault, r = t.options, o = r.angleLines, d = r.pointLabels;
                ...
                var f = t.helpers, g = t.defaults.global, p = {
                    ...
                    setDimensions: function () {
                        ...
                        var i = this, a = e.l / Math.sin(n.l), r = Math.max(e.r - i.width, 0) / Math.sin(n.r),
                            o = -e.t / Math.cos(n.t), l = -Math.max(e.b - i.height, 0) / Math.cos(n.b);
                        a = h(a), r = h(r), o = h(o), l = h(l), i.drawingArea = Math.min(Math.round(t - (a + r) / 2), Math.round(t - (o + l) / 2)), i.setCenterPoint(a, r, o, l)
                    }, setCenterPoint: function (t, e, n, i) {
                        var a = this, r = a.width - e - a.drawingArea, o = t + a.drawingArea, l = n + a.drawingArea,
                        ...
                        if (e.display) {
                            var r = t.ctx, o = a(i.fontSize, g.defaultFontSize), l = a(i.fontStyle, g.defaultFontStyle),
                                s = a(i.fontFamily, g.defaultFontFamily), u = f.fontString(o, l, s);
            ...
            i = "function" == typeof i ? i : window.moment, e.exports = function (t) {
                ...
                function a(t, e, n, i) {
                    var a = l[n], r = a.size, o = Math.ceil((e - t) / r), s = 1, u = e - t;
                    if (a.steps) for (var d = a.steps.length, c = 0; d > c && o > i; c++) s = a.steps[c], o = Math.ceil(u / (r * s)); else for (; o > i && i > 0;) ++s, o = Math.ceil(u / (r * s));
                    return s
                }
                ...
                var u = t.Scale.extend({
                    initialize: function () {
                        ...
                        var t, n = this, i = n.options.time, a = Number.MAX_SAFE_INTEGER, r = Number.MIN_SAFE_INTEGER,
                        ...
                        var h = l.getLabelCapacity(i || u), f = s.unit || n(s.minUnit, i || u, r || d, h);
                        ...
                        }, {min: u, max: d}), l.max = o.max(l.ticks), l.min = o.min(l.ticks)
                        ...
                        var n = this, i = n.options.ticks, a = n.ctx.measureText(e).width,
                            r = Math.cos(o.toRadians(i.maxRotation)), l = Math.sin(o.toRadians(i.maxRotation)),
                        ...
                        var n = e.tickFormatFunction(i(t), 0, []), a = e.getLabelWidth(n),
                            r = e.isHorizontal() ? e.width : e.height, o = r / a;
                        return o
                    }
                });
